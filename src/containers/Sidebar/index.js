          ...
          <div className="scroll">
            ...
            >
              <Nav vertical className="list-unstyled">
                ...
                >
                  <NavLink
                    to="/entries?chr=chr1&start=1&end=900000"
                  >
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "methods" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="methods")
                  })}
                >
                <NavLink
                  to="/methods"
                ...
                <NavItem
                  className={classnames({
                    active: ((this.state.selectedParentMenu == "about" && this.state.viewingParentMenu=="" )|| this.state.viewingParentMenu=="about")
                  })}
                >
                <NavLink
                  to="/about"
